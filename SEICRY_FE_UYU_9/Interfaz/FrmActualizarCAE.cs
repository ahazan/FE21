...
{
    /// <summary>
    /// Contiene los metodos para mostrar el formulario que permite actualizar un rango de CAE
    /// </summary>
    class FrmActualizarCAE : FrmBase
    {
        ...
        /// </summary>
        /// <param name="formUID"></param>
        public void CrearComponentess(string formUID, string numeroRango)
        {
            AgregarDataSources();
            EstablecerDataBind();
            Consultar(numeroRango);
        }
        ...
        {
            //Establecer data bind al combo box
            ...
            //Asigna los valores válidos al combo box
            ...
            ((ComboBox)cbxTipoDocumento.Specific).ValidValues.Add("121", "e-Factura Exportacion");
            ((ComboBox)cbxTipoDocumento.Specific).ValidValues.Add("122", "NC. e-Factura Exportacion");
            ((ComboBox)cbxTipoDocumento.Specific).ValidValues.Add("123", "ND. e-Factura Exportacion");
            ((ComboBox)cbxTipoDocumento.Specific).ValidValues.Add("124", "e-Remito Exportacion");
        ...
        {
            if (Regex.IsMatch(((EditText)Formulario.Items.Item("txtNumIn").Specific).String, Mensaje.expRegNumeroInicial))
            {
        ...
        {
            DateTime valor;
            if (DateTime.TryParse(((EditText)Formulario.Items.Item("txtValHa").Specific).String, out valor))
            {
                return true;
            }
        ...
        /// <summary>
        /// Toma los valores del formulario para actualizarlos en la base de datos.
        /// <para>0=Valores ingresados.</para>
        /// <para>1=Valores no ingresados.</para>
        /// <para>2=Valores no validos</para>
        /// </summary>
        /// <returns></returns>
        public int Actualizar(string numeroRango)
        {
            bool resultado;
            ...
            if (Validar())
            {
                ...
                resultado = manteUdoCae.Actualizar(cae, numeroRango);
        ...
        //Numero de rango seleccionado para consultar y modificar
        private string numeroRangoSeleccionado;

        /// <summary>
        /// Numero de rango seleccionado para consultar y modificar
        /// </summary>
        public string NumeroRangoSeleccionado
        {
            get { return numeroRangoSeleccionado; }
            set { numeroRangoSeleccionado = value; }
        }
